...
//THE BELOW NEEDS TO BE UPDATED WITH THE CURRENT OUTPUT AVAILABLE THINGS
    ...
    for(int k=0;k<N;k+=field_sliceskip)
    {
        ...
        for(int fld=0;fld<nflds;fld++)
        {
            fprintf(slicefield,"%Le %Le %Le %Le %Le", dfdr(field,0,fld,k,N/2,N/2), dfdr(field,0,fld,N/2,k,N/2), dfdr(field,0,fld,N/2,N/2,k),dfdr(field,0,fld,k,k,N/2),dfdr(field,0,fld,N-k-1,k,N/2));
