...
LINKS= -L/opt/local/lib -lfftw3l  

do: fclean dirmake oclean compile 

xcmake : do
	
compile: g2header.h g2parameters.h g2model.o g2functions.o g2output.o g2main.o 
	$(COMPILER) $(FLAGS) g2model.o g2functions.o g2output.o g2main.o $(LINKS) -o gabe
