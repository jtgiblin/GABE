...
const long double f0[2] = {phi0};        //array storing intial phi and chi field values
const long double df0[2] = {-0.142231};  //array storing intial phi and chi field derivative values
 ...
 ***************************/
#define parallelize 0                 // for parallelization set to 1 and set other variables set to 0 for no parallelization
#define tot_num_thrds 1               // total (max) number of threads to run durring program
const int randseed = 44463132;        // seed for rand number generator
const int N = 256;                    // number of points along one side of grid
...
#define spec_output 0                 // 1 to ouptu spectra zero for no spectra output
#define var_output 0                  // 1 to output mean and varraince zero for no varriance output
