...
const gNum sigma2 = 0.05; // Value of sigma-squared*2 in the gaussian energy density. May not need this value if energy density is not gaussian or some other form.
...
#define tot_num_thrds 5//total (max) number of threads to run durring program
...
const int slicenumber=200;//approx number of slices to output (only used if slicewait=0)
